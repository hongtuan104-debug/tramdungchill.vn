...
function buildFooter(opts) {
    ...
    return [
        ...
        // Nhãn footer là <p>, KHÔNG phải heading (15/09/2026, checklist #10 mục 71): footer lặp trên
        // mọi trang, để h3/h4 là cả 4 nhãn chen vào dàn bài của trang, nối đuôi section cuối.
        ...
        "            </div>",
        '            <div class="footer-nav">',
        '                <p class="footer-title"' + i18nAttr("footer.occasion.title", mode) + ">" + txt("footer.occasion.title", mode) + "</p>",
        "                <ul>",
        ...
        '                <p class="footer-title"' + i18nAttr("footer.contact.title", mode) + ">" + txt("footer.contact.title", mode) + "</p>",
        "                <ul>",
