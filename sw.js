...
const CACHE_NAME = 'tdc-v13-484f926e';
const STATIC_ASSETS = [
    '/index.html',
    '/dist/common.min.js?v=6b7c7c9a',
    '/dist/index.min.js?v=757d7a24',
    '/data/site-config.js?v=0aa35834',
    '/data/translations.js?v=d7f59f6e',
    '/manifest.json',
