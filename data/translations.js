...
var TRANSLATIONS = {
  vi: {
    ...
    'flip.priceTag': 'Bảng giá',
    'flip.priceTitle': 'Giá từng món<br><em>tra nhanh, không cần lật</em>',
    ...
    'faq.a3': 'Từ 95.000đ đến 300.000đ một người, đã gồm VAT. Nhóm 4 người thường hết khoảng 800.000đ – 1.200.000đ. Menu có hơn 70 món gọi lẻ ghi rõ giá, gồm nướng BBQ, lẩu, hải sản và đồ uống.',
    ...
    'faq.a10': 'Món signature là Bò Tảng Sốt Phô Mai Trứng Muối — best-seller được khách nhắc nhiều nhất. Ngoài ra hải sản nướng (tôm sú, mực lá, sò điệp) và các loại lẩu (Thái hải sản, gà lá é, riêu cua) cũng rất được ưa chuộng.',
  ...
  en: {
    ...
    'flip.priceTag': 'Price list',
    'flip.priceTitle': 'Every dish and price<br><em>searchable, no flipping</em>',
    ...
    'faq.a3': 'From 95,000₫ to 300,000₫ per person, VAT included. A group of four usually spends around 800,000₫ – 1,200,000₫. The menu lists over 70 à la carte dishes with clear prices, covering BBQ, hotpot, seafood and drinks.',
    ...
    'faq.a10': 'Our signature is the Beef Slab with Cheese and Salted Egg Sauce — the best-seller guests mention most. Grilled seafood (tiger prawns, squid, scallops) and our hotpots (Thai seafood, chicken with basil leaves, crab) are also very popular.',
