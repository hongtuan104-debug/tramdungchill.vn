...
try { new ResizeObserver(invalidate).observe(document.body); } catch (e) { }
} else {
...
sc.onerror = function () { veQR(container); };
...
if (document.getElementById('stickyBookBar')) return;
